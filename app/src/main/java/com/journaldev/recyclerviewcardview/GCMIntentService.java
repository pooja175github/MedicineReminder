    ...
    import com.journaldev.recyclerviewcardview.Notification.single_notification;
    ...
    private static void generateNotification(Context context, String message,String Title,String img,String Link) {
        ...
        try {
            ...
            id=manageNotification.InsertNotification(context,Title,message,Link,img,date,time);
       ...
       int defaults = 0;
        ...
        b.setContentIntent(PendingIntent.getActivity(context, id, intent1, 0));
